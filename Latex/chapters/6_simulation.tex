...
Dies ist möglich, da die genaue Fahrzeugposition anhand der erfassten Steuerbefehle für das simulierte Fahrzeug bestimmt werden kann.
...
Die Frequenz kann entsprechend simuliert werden und die Daten entsprechend dem Datenblatt generiert werden. 
