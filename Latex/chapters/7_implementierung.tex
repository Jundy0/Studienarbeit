...
Wie bereits in der Technologie-Entscheidung beschrieben, wird für die Ansteuerung des \ac{lidar}s die RPLIDAR SDK verwendet. 
...
Zur einfacheren Übertragung werden die Werte für den Winkel und den Abstand bei der SDK als unsigned 16 bit bzw. 32 bit Integer gespeichert. 
...
Der selbe Vorgang wird für die freien Punkte wiederholt.
...
Die, für den \ac{icp}-Algorithmus verwendeten Parameter, sowie typedefs, welche den Code übersichtlicher machen, lassen sich in der Header-Datei finden.
