...
Die Daten werden verarbeitet und in einer Punktewolke gespeichert. \ref{fig:registrationExample}
...
Die simpelste Form eines solchen Feature-Deskriptor wäre die Normale der Fläche unter dem Punkt. \ref{fig:normals}
